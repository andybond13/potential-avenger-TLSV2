...
#lc = 3./4.*Gc/Yc
print "*** lc = ",lc
end_t = 4e-2 * 0.25 / strain_rate /100 /2 
print "end_t=",end_t
...
frontExtension = 0  #0, 1, or 2. If 0, explicit delay-damage front extension. If 1, implicit-type NR solve. If 2, explicit NR-style solve (use with maxIteration = 1 for example) 
maxIteration = 1   #>= 1. If 1, single iteration.
