...
plot './datFiles/residual2.dat' using 1:22 ti '' with points;

set xlabel "log10(R1/Yc)"
set ylabel "log10(R2/Yc,R3/Yc,R4/Yc)"
set output './pngFiles/residualSumr1r2.svg'
plot './datFiles/residual2.dat' using (log10(abs($22))):(log10(abs($22))) ti 'R1' with points, \
     './datFiles/residual2.dat' using (log10(abs($22))):(log10(abs($23))) ti 'R2' with points, \
     './datFiles/residual2.dat' using (log10(abs($22))):(log10(abs($24))) ti 'R3' with points, \
     './datFiles/residual2.dat' using (log10(abs($22))):(log10(abs($25))) ti 'R4' with points;
...
set xtics (1,2,3,4)
set xrange [0.5:4.5]
plot for[i=22:25] './datFiles/residual2.dat' using (i-1):(log10(abs(column(i)))) with points;
